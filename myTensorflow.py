...
layer1 = create_conv_layer(x_shaped, 1, 50, [5, 5], dropout_rate=0.3, name='layer1_conv')
layer1 = create_max_pooling(layer1, [2,2], name='layer1_max_pooling')
print("layer1: ", layer1.get_shape());

layer2 = create_conv_layer(layer1, 50, 50, [5, 5], dropout_rate=0.3, name='layer2_conv')
